...
class PhoneLoginHandler(BaseHandler):
    methods = ['POST']
    ...
    def __init__(self):
        ...
        super(PhoneLoginHandler, self).__init__(expect_request_para, need_para)
    ...
    def _process_imp(self):
        ...
        UserDao.update({
            ...
            "channel": channel
        }, where_col="phone", where_col_str=True
        )

        # 生成新的sid
        new_sid = app_token_util.make_sid(user["source"], user["id"], device_type, cuid)
